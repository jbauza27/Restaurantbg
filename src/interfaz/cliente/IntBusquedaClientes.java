...
/**
 * Para realizar búsqueda de clientes según determinados criterios.
 */
public class IntBusquedaClientes extends javax.swing.JDialog
{
    /* Atributos */
    ...
    /* Constructor */
    public IntBusquedaClientes(java.awt.Frame parent, boolean modal, Session sesion)
    {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Restaurant \"Buen gusto\" - Menú de búsqueda de clientes");
        ...
        jlBusquedaDeClientes.setText("Búsqueda de clientes");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jlBusquedaDeClientes, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jCheckBoxProvincia, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(jCheckBoxNombre, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    */
    ...
    /**
     * Realiza la búsqueda de clientes que se correspondan con determinados criterios
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        ...
        else
        {
            ...
            listaClientes = (ArrayList<Cliente>) query.list();    
            
            IntMostrarClientes intMostCli =
                    new IntMostrarClientes(null, true, sesion, listaClientes);
            this.dispose();
            intMostCli.setVisible(true);                            
        }
    }//GEN-LAST:event_jbBuscarActionPerformed
    
    /**
     * Teniendo en cuenta los criterios seleccionados y sus correspondientes
     * valores, prepara la sentencia HQL que se utilizará para traer los clientes
     * deseadas.
     * 
    ...
    {       
        String hql = "C.nombre LIKE '" + nombre + "'";
    ...
    {       
        String hql = "C.apellido LIKE '" + apellido + "'";
    ...
    {
        String hql = "C.pais.nombrePais = '" + pais + "'";
    ...
    {
        String hql = "C.provincia.nombreProvincia = '" + provincia + "'";
    ...
    /**
     * Si se activa el checkbox 'apellido', entonces se activa el campo de
     * texto 'apellido'. Caso contrario, es decir, si se desactiva el
     * checkbox 'apellido', entonces también se desactiva el campo de texto
     * 'apellido'.
     * 
     * @param evt el evento de cambio de estado del checkbox
     */
